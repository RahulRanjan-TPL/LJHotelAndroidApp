...
import com.macernow.ljhotelandroidapp.sysConfig.ChangeVODServerActivity;
import com.macernow.ljhotelandroidapp.sysConfig.ChangeWebServerActivity;
import com.macernow.ljhotelandroidapp.upgrade.UpgradeInfo;
import com.macernow.ljhotelandroidapp.upgrade.UpgradeInfoParser;
...
public class SystemConfigActivity extends ActionBarActivity {
    ...
    protected void downloadApk() {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    File file = com.macernow.ljhotelandroidapp.upgrade.DownloadManager.getFileFromServer(upgradeInfo.getUrl(),progressDialog);
                    sleep(3000);
                    installApk(file);
