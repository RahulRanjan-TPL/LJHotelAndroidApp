...
/**
 * Created by djstava on 15/4/27.
 */

public class VideoSlidingMenu extends RelativeLayout implements View.OnTouchListener {
     ...
     * @param attrs
     */
    public VideoSlidingMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
